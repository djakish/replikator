...
export default function DynamicDatabase() {
  ...
  const dataSource = [
    {
      name: <Text b>Photos</Text>,
      date: "April 18 16:16",
      backup: "",
      delete: "",
    },
    {
      name: <Text b>Game Saves</Text>,
      date: "April 18 16:16",
      backup: "",
      delete: "",
    },
    {
      name: <Text b>Documents</Text>,
      date: "April 18 16:16",
      backup: "",
      delete: "",
    },
    {
      name: <Text b>Assignments</Text>,
      date: "April 18 16:16",
      backup: "",
      delete: "",
    },
    {
      name: <Text b>Tv Shows</Text>,
      date: "April 18 16:16",
      backup: "",
      delete: "",
    },
        ...
        <Grid sm={22}>
          <Card hoverable shadow width="100%">
            ...
            <Modal width="35rem" {...bindings}>
              ...
              <Modal.Content>
                <Grid.Container gap={2}>
                  ...
                  <Grid>
                    {" "}
                    <Button auto scale={0.75} width="100%">
                      {" "}
                      Pick an input{" "}
                    </Button>
                  </Grid>
            ...
            <Table data={data}>
              ...
              <Table.Column prop="backup" width={50} render={renderAction} />
              <Table.Column
                prop="delete"
                label=""
                width={50}
